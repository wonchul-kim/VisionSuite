...
if __name__ == "__main__":
    ...
    parser.add_argument("--clusters_path", default='/HDD/etc/curation/data/level1/pre_clusters/sorted_clusters.npy')
    ...
    parser.add_argument("--save_path", default='/HDD/etc/curation/data/level1')
