...
def split_clusters(
    ...
    print("******** X_ori.shape: ", X.shape) # 668985
...
if __name__ == "__main__":
    ...
    parser.add_argument("--clusters_path", default='/HDD/datasets/projects/benchmarks/mr_ad_bench/clustered/dinov2-large/attention_False/preclusters/sorted_clusters.npy')
    ...
    parser.add_argument("--save_path", default='/HDD/datasets/projects/benchmarks/mr_ad_bench/clustered/dinov2-large/attention_False/level1')
