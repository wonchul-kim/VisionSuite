...
data_root = '/HDD/datasets/public/visiondrone/'
...
data = dict(
    ...
    train=dict(
        ...
        dataset = dict(type=dataset_type,
            classes=classes,
            ann_file=data_root + '/VisDrone2019-DET_train_coco_1crop.json',
            img_prefix=data_root + '/VisDrone2019-DET-train-crop/images',
            pipeline=[
                dict(
