...
def get_datasets(dataset, transform, root_dir='./data'):
    ...
    #     pass
        ...
        train_dataset = LabelmeDataset(root=os.path.join(data_path, 'train'), transform=transform)
        train_dataset = LabelmeDataset(root=os.path.join(data_path, 'val'), transform=transform)
