...
def parse_args():
    ...
    # parser.add_argument('--config', default='/HDD/_projects/github/VisionSuite/visionsuite/cores/spatial_transform_decoupling/configs/rotated_imted/dota/vit/rotated_imted_faster_rcnn_vit_small_1x_dota_le90_8h_stdc_xyawh321v.py')
