...
from visionsuite.cores.InfoBatch.infobatch import InfoBatch
from torchvision import transforms
from visionsuite.cores.InfoBatch.examples.model import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_info_batch', default=True)
