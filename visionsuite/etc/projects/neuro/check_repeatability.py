        ...
        for iou_threshold in iou_thresholds:
            for area_threshold in area_thresholds:
                for conf_threshold in conf_thresholds:
                    ...
                    json_files1 = sorted(glob(osp.join(base_dir, dir_name, case, '1/*.json')))
                    ...
                    for json_file1 in tqdm(json_files1, desc=f"{dir_name}: IoU({iou_threshold}) & Area({area_threshold} & Conf({conf_threshold}))"):
                        ...
                        json_file2 = osp.join(base_dir, dir_name, case, f'2/{filename}.json')
                        json_file3 = osp.join(base_dir, dir_name, case, f'3/{filename}.json')
