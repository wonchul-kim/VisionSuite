...
class2index = {'NG': 0}
# output_dir = '/DeepLearning/research/data/unittests/unit_cost_test/sage/split_interojo_dataset/train.srproj'
output_dir = '/DeepLearning/research/data/unittests/unit_cost_test/sage/split_interojo_dataset/test.srproj'
json_dir = '/DeepLearning/research/data/unittests/unit_cost_test/split_interojo_dataset'
