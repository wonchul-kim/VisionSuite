...
if __name__ == '__main__':
    ...
    input_dir = '/HDD/_projects/benchmark/obb_detection/rich/datasets/split_dataset_box'
    output_dir = '/HDD/_projects/benchmark/obb_detection/rich/benchmark/dataset'
